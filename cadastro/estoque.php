...
<head>
  <title>FoodControl - Estoque</title>
  <meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
    ...
    <script type="text/javascript">
      function salvar()
      {
        ...
        var forma_quantidade=document.getElementById('formaQuantidade').value;
        var queryString = "id="+id+"&descricao="+descricao+"&quantidade="+quantidade+"&formaQuantidade="+forma_quantidade;
        var campos=['descricao','quantidade','formaQuantidade'];
        if(validaCampos(campos))
          buscaDados("statusCadastro",queryString,"../get/getItemEstoque.php?action="+acao,"Não foi possível cadastrar",'../');
      }
      ...
      function excluir()
      {
        ...
        buscaDados("statusExcluir",queryString,"../get/getItemEstoque.php?action=delete","Não foi possível excluir o item",'../');
      }
      ...
      $('[data-toggle=modal]').click(function ()
      {
        ...
        //************************************************
        var data_quantidade = '';
        if (typeof $(this).data('quantidade') !== 'undefined') 
        {
          data_quantidade = $(this).data('quantidade');
        }
        $('#quantidade').val(data_quantidade);
        //************************************************
        var data_forma_quantidade = '';
        if (typeof $(this).data('forma-quantidade') !== 'undefined') 
        {
          data_forma_quantidade = $(this).data('forma-quantidade');
        }
        $('#formaQuantidade').val(data_forma_quantidade);
      });
      });
    </script>
          ...
          <div class="modal-dialog">
              <div class="panel panel-warning">
                  ...
                  <div class="panel-heading">
                          ...
                          <h4 class="panel-title" id="contactLabel"><span class="glyphicon glyphicon-list-alt"></span> Excluir Item do Estoque:</h4>
                  </div>
      ...
      <div class="modal fade" id="modalCadastro" tabindex="-1" role="dialog" aria-labelledby="contactLabel" aria-hidden="true">
          <div class="modal-dialog">
              <div class="panel panel-warning">
                  ...
                  <div class="panel-heading">
                          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
                          <h4 class="panel-title" id="contactLabel"><span class="glyphicon glyphicon-list-alt"></span> Cadastro de Item no Estoque:</h4>
                  </div>
                  <form id="cadastroForm" accept-charset="utf-8">
                      <div class="modal-body" style="padding: 5px;">
                              ...
                              <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6" style="padding-bottom: 10px;">
                                  <span class="help-block">Tipo de Quantidade*:</span>
                                    <select id="formaQuantidade" name="formaQuantidade" class="form-control" required="required">
    ...
    <center>
      ...
      <div class="row">
        <div id="bc1" class="btn-group btn-breadcrumb">
            ...
            <a href="#" class="btn btn-default active"><div>Cadastro de Estoque</div></a>
        </div>
                      ...
                      <ul class="list-group">
                        <div class=" table table-hover table-responsive">
                          <?php 
                            ...
                            $cClass->listar('produto_estoque','descricao');
                            $count=0;
                              ...
                              <table class="table table-hover table-condensed">
                                <thead>
                                  <tr class="filters">
                                      ...
                                      <th><input type="text" class="form-control" placeholder="Forma Quant." disabled></th>
                                  </tr>
                                </thead>
                              <?php
                              while($array_ = mysqli_fetch_array($cClass->getConsulta()))
                              {
                                ...
                                ?>
                                    <tr>
                                      ...
                                      data-quantidade="<?php echo $array_['quantidade'];?>"
                                      data-forma-quantidade="<?php echo $array_['formaQuantidade'];?>"
                                      data-action="editar"
                                      >
                                        <small style="color:#080808;font-size: 110%"><?php echo $array_['descricao'];?></small>
                                      </td>
                                       <td>
                                        <small style="color:#EB2626;font-size: 100%"><?php echo $array_['quantidade'];?></small>
                                      </td>
                                      <td>
                                        <small style="color:#080808;font-size: 110%">
                                          <?php switch ($array_['formaQuantidade']) {
                                            case 'ml':
                                                echo 'ml';
                                              break;
                                            case 'l':
